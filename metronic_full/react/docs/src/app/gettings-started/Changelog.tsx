            ...
            <div className='accordion-body ps-0 pt-0'>
              <div className='mb-5'>
                ...
                <ul className='my-0 py-0'>
                  <li className='py-2'>
                    Progress bar on route change. <a href="https://preview.keenthemes.com/metronic8/react/demo1/" className={"ml-2"}>Preview</a>
                  </li>
                </ul>
              ...
              <div className='mb-5'>
                ...
                <ul className='my-0 py-0'>
                  <li className='py-2'>
                    ...
                    <a className="mb-2" href='https://preview.keenthemes.com/metronic8/react/demo1/'>Preview</a>
                  </li>
                </ul>
                <h3 className='fs-6 fw-bolder mb-1'>Updates:</h3>
                <ul className='my-0 py-0'>
