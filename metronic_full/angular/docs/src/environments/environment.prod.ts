  ...
  changelogs: [
    {
      ...
      'changelog': {
        ...
        'fix': [
          'Fixed aside menu accordion cannot be closed after navigate with aside menu link.',
          'Fixed breadcrumb issue when click link or tab.',
          'Fixed off-canvas stop working after navigate with aside menu link.',
          'Fixed left menu navigation focus lost',
          'Fixed aside menu drawer in mobile view.',
          'Fixed changelog listing page.',
        ],
      }
    },
    {
